...
type Member={name:string;id:string;icon?:string|undefined;owned:boolean;rank:number|null;xpLevel:number|null;activeLevel:number|null;passiveLevel:number|null;activeTarget:string;passiveTarget:string};
