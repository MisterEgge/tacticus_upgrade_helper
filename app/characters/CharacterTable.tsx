...
{key:"name",label:"Character",sort:r=>r.name,search:r=>r.name,render:r=><Link className="characterLink" href={"/characters/"+encodeURIComponent(r.id)}><CharacterName name={r.name} id={r.id}/></Link>},
